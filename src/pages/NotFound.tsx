    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="text-center space-y-6 p-8">
        <div className="space-y-2">
          ...
          <h2 className="text-2xl font-trebuchet ms text-foreground">Page Not Found</h2>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Button 
            ...
            className="border-2 border-primary/20 text-primary hover:bg-primary/10 font-semibold px-6 py-3 rounded-full transition-all duration-300 hover:scale-105"
          >
