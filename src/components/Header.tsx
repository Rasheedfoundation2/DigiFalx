      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            ...
            <span className="text-2xl font-bold gradient-text dark:gradient-text-dark">Digifalx</span>
          </Link>
          ...
          <div className="md:hidden py-4 space-y-2 glass dark:glass-dark mt-2 rounded-lg">
            ...
            <div className="px-4 pt-2">
              <Link to="/contact" onClick={() => setIsOpen(false)}>
                <Button className="w-full primary-gradient hover:from-blue-700 hover:via-purple-700 hover:to-indigo-700 dark:primary-gradient-dark dark:hover:from-blue-300 dark:hover:via-purple-300 dark:hover:to-indigo-300 text-white dark:text-slate-900 font-semibold rounded-full">
                  Get Started
                </Button>
              </Link>
            </div>
